...
public class EarthquakeCityMap extends PApplet {
	...
	// Extension: airportsUrl
	private String airpotsUrl = "airports.dat";
	...
	public void setup() {		
	    ...
	    // Extension: read in airport RSS feed
	    List<PointFeature> airports = ParseFeed.parseAirports(this, airpotsUrl);
	    airportMarkers = new ArrayList<Marker>();
	    
	    for (PointFeature feature : airports) {
	    	feature.addProperty("destinations", new HashSet<Marker>());
	...
	private void sortAndPrint(int numToPrint) {
		...
		Arrays.sort(markers);
		if (numToPrint > markers.length) {numToPrint = markers.length;}
	...
	public void mouseClicked()
	{
		...
		else if (lastClicked == null) 
		{
			...
			if (lastClicked == null) { checkAirportsForClick();}
		}
	}
	...
	private void addKey() {	
		...
		text("Airport Marker", xbase+50, ybase+110);
