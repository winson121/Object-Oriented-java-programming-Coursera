...
//		earthquakesURL = "quiz1.atom";
	...
	private void addKey() {	
		...
		fill(255,30, 70);
		triangle(55, 110, 60, 100, 65, 110);
		fill(255, 255, 255);
		ellipse(60, 130, 15, 15);
		fill(255, 255, 255);
		rect(53, 150, 15, 15);
	...
	private void printQuakes() 
	{
		...
		int oceanQuakesNum = quakeMarkers.size();
		for (Marker cm : countryMarkers) {
			...
			if (landQuakeCounter > 0) {
				oceanQuakesNum -= landQuakeCounter;
				System.out.println(name + " : " + landQuakeCounter);
			}
		}
		System.out.println("OCEAN QUAKES : " + oceanQuakesNum);
	}
